...
function Run-Test($tag, $expert, $from, $to, $model) {
    ...
    $mt = if ($tag -like "*lg60*") { "6.0" } else { "5.0" }
...
Run-Test "lg50_2023" "SemiMartiV10_Gated" "2023.01.01" "2023.12.31" 1
Run-Test "lg60_2023" "SemiMartiV10_Gated" "2023.01.01" "2023.12.31" 1
